...
![clude](./images/finishdownlaodclaude.png)
...
3. Open the folder in VS Code:  
   ...
   - Click the Open folder from the sidebae and just select the folder that you have created.
...
1. **In the VS Code Terminal**  
   Make sure you're in the terminal that you opened in Step 7.

2. **Clone the Repository**  
   Type the following command and press **Enter**:
   
   ```bash
   git clone https://github.com/sachin0034-tech/aipminterview-bootcamp-project-repo.git
   ```
   
   This will download the bootcamp project repository to your current folder.

   ![terminal](./images/repoclone.png)

3. **Wait for Completion**  
   - The repository will be cloned into a folder named `aipminterview-bootcamp-project-repo`.  
   - You'll see a message indicating the clone was successful once it's complete.

  ![terminal](./images/finalclone.png)

> **Note:** Now you can see that we have cloned one folder which contains the context for our lesson. We will explore this in our next module.

---

## Step 9: Run Claude in the Terminal

Follow these steps to run Claude from your VS Code terminal:

1. **Navigate to the Cloned Folder**  
   First, navigate to the folder that you have cloned. In the terminal, type:
   
   ```bash
   cd aipminterview-bootcamp-project-repo
   ```
   
   This will change your current directory to the cloned repository folder.
