...
4. **Git:**  
   Git is a **version control system** that helps you track changes in your code and collaborate with others. In this course, you'll use Git to clone repositories (download project files) and keep your work organized. Think of it as a time machine for your code that lets you save different versions and work safely.  
...
Follow the video tutorials below to install Git on your system:

1. **For Mac Users:**  
   Watch this video tutorial to install Git on macOS:  
   [Git Installation for Mac Click Here](https://youtu.be/kdM9YOX2hZ0?si=AEQ8N_OlSuwOR2fj)  
   Follow the steps in the video and you're good to go!

2. **For Windows Users:**  
   Watch this video tutorial to install Git on Windows:  
   [Git Installation for Windows Click Here](https://youtu.be/iYkLrXobBbA?si=xxAot5SgAokiOYLv)  
   Follow the steps in the video and you're good to go!
...
3. **Verify Installation (Optional)**  
   - Open **Terminal** (Mac) or **Command Prompt** (Windows) and run:  
     ...
     git --version
     ```  
   - This will display the installed Git version to confirm the installation was successful.

---

###  **→ What's Next?**
**Now you have installed Node.js, VS Code, and Git!**  
