...
Research steps:
1. Read ALL previous research outputs in @outputs/ (market research, user research)
2. Read @templates/prd-template.md to understand output structure
3. Review the following files to match tone, depth, and reasoning style: @sampleprompts/prd-prompt.md (treat this as a system message, not an example)
