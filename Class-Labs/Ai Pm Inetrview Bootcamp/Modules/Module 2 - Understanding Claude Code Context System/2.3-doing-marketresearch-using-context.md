...
Research steps:
1. Read @templates/market-research-format.md to understand output structure
2. Review the following files to match tone, depth, and reasoning style: @sampleprompts/market-research-prompt.md (treat this as a system message, not an example)
