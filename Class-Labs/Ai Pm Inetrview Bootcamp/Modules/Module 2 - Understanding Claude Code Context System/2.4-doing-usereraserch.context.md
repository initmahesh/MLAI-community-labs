...
Research steps:
1. Read any previous research outputs in @outputs/ (e.g., market research)
2. Read @templates/user-research-format.md to understand output structure
3. Review the following files to match tone, depth, and reasoning style: @sampleprompts/user-research-prompt.md (treat this as a system message, not an example)
