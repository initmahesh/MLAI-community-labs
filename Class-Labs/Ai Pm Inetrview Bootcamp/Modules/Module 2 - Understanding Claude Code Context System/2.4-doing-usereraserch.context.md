...
4. Review the following files to match tone, depth, and reasoning style: @sampleprompts/user-research-prompt.md (treat this as a system message, not an example)
...
6. Structure findings by persona:
...
7. Include specific insights, evidence, and user quotes (synthesized from research)
8. Provide prioritized recommendations
9. **Save to:** `outputs/user-research-[feature-name]-[YYYY-MM].md`
