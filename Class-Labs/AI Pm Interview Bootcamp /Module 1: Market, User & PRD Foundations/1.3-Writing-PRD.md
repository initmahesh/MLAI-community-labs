...
Market research and user research in this module will be **fully hands-on and executed using Claude Code**. If your setup is incomplete, you may face issues while running commands or generating outputs.

### **→ Hands-On: Creating a PRD Using Claude Code**
...
This prompt will serve as your **master instruction** for generating hands-on, research-backed PRDs in this module.
