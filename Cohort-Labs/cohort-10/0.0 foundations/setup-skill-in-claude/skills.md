...
This lesson is about building your own **skills**. Here you define the prompt, the output structure, and the behavior. By the end you'll have three skills — `/market-research`, `/user-research`, and `/prd`
