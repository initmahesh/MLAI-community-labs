# Lab 3.1: Subagents and Connectors

Your `contract-review-app` works end to end, but two questions are still open: is the code underneath actually any good, and do real users actually like it? This lab answers both.
...
> Work through 3.1.1 before 3.1.2 — the feedback form lab assumes the app's code has already been reviewed and cleaned up.
