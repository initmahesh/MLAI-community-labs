...
Go back to the agent you built in [Lab 1.1 — Build Your First AI Agent in n8n](../../week-1-intro-agents/1.1%20-%20n8n-agent/build-from-scratch.md), or you can download the workflow from here:
