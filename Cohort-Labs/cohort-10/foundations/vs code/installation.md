...
Lesson 1.3  is all about setting up Claude Code and completing the authentication process. This section acts as a handy reference to guide you alongside the hands-on tutorial.
...
7. **Check Node Version (Optional)**  
   ...
   ![nodejs](../../images/nodejsversioncheck.png)
